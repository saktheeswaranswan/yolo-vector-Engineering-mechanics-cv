...
while True:
    ...
    for i in range(len(boxes)):
        ...
        # Create a grid with the center as the origin
        for dx in range(-width // 2, width // 2, grid_step):
            for dy in range(-height // 2, height // 2, grid_step):
                start_point = (center_x + dx, center_y + dy)
                end_point = (center_x + dx + 10, center_y + dy + 10)  # Example vector
